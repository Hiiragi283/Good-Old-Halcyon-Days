...
//作業台レシピの編集
	//上書き
	//新規
	HiiragiUtils.addCraftingShaped(false, <contenttweaker:ingot_stable>, [[<ore:ingotEnchantedMetal>], [<contenttweaker:division_sigil_perm>], [<ore:gemMoon>]], null, null);
	HiiragiUtils.addCraftingShaped(false, <contenttweaker:ingot_unstable>, [[<ore:ingotEnchantedMetal>], [HiiragiUtils.toolInput(<contenttweaker:division_sigil_temp>, 1)], [<ore:gemMoon>]], null, null);
