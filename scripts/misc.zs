...
HiiragiUtils.addCrafting(true, false, HiiragiUtils.gregItem(347), [[<tconstruct:pattern>]]);
HiiragiUtils.addCrafting(true, false, <tconstruct:pattern>, [[HiiragiUtils.gregItem(347)]]);

HiiragiUtils.addCrafting(true, false, <ore:blockGrout>.firstItem, [[<ore:dustGrout>, <ore:dustGrout>, <ore:dustGrout>, <ore:dustGrout>]]);
HiiragiUtils.addCrafting(true, false, <contenttweaker:grout_ingot>*4, [[HiiragiUtils.gregItem(348).reuse(), <ore:blockGrout>]]);
