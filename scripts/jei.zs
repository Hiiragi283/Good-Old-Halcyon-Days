...
static tableStencil as IItemStack = <tconstruct:tooltables:1>.withTag({textureBlock: {id: "twilightforest:twilight_log", Count: 1 as byte, Damage: 0 as short}});
static tablePart as IItemStack = <tconstruct:tooltables:2>.withTag({textureBlock: {id: "twilightforest:twilight_oak_planks", Count: 1 as byte, Damage: 0 as short}});
...
val mapRemove as bool[IItemStack] = {
	//Advanced Rocktry
	<advancedrocketry:platepress>: false,
	<advancedrocketry:arcfurnace>: false,
	<advancedrocketry:rollingmachine>: false,
	<advancedrocketry:lathe>: false,
	<advancedrocketry:crystallizer>: false,
	<advancedrocketry:cuttingmachine>: false,
	<advancedrocketry:precisionassemblingmachine>: false,
	<advancedrocketry:electrolyser>: false,
	<advancedrocketry:chemicalreactor>: false,
	<advancedrocketry:precisionlaseretcher>: false,
	<advancedrocketry:centrifuge>: false,
	...
	//LibVulpes
	<libvulpes:advstructuremachine>: true,
	//Mekanism
...
for i, j in mapRemove {
	...
	//Advanced RocketryとLibVulpesの不要なアイテムをJEIから削除
	...
	for i in 0 to 2 {
		for j in removeAdvRocketry {
			removeJEI(j.definition.makeStack(i), true);
		}
	}
